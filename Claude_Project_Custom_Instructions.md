...
## Framework Documents
- **PM Guidelines** (Folder computer_vision_Project_Knowledge: ..\berto\computer_vision_Project_Knowledge): Project planning structure
- **Collaboration Methodology v1.1.1** (Folder computer_vision_Project_Knowledge: ..\berto\computer_vision_Project_Knowledge): Execution workflow
- **DSM_0 Complete Guide** (Folder computer_vision_Project_Knowledge: ..\berto\computer_vision_Project_Knowledge): System overview
